"""Gnosis chain client with POA middleware, gas estimation, receipt waiting."""
...
class GnosisClient:
    """Web3 client for Gnosis Chain (chain ID 100) with POA support."""

    def __init__(self, rpc_url: str, private_key: str):
        self.w3 = AsyncWeb3(AsyncHTTPProvider(rpc_url))
        # Gnosis is a POA chain — inject middleware to handle extraData
    ...
    async def get_balance(self) -> int:
        """Get native token (xDAI) balance in wei."""
